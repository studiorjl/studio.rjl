...
export const offers = [
  {
    ...
    steps: [],
    includes: [
      "logo â brandmark, submark (delivered as a range of png & svg file types)",
      "palette â colours, font pairings, 3 textures and 3 images; art direction and curation",
      "brandscape guide â designed specifically for you to import into Canva, Adobe or Figma"
    ],
    notes: [
      "due to the nature of this offer, its turnaround and delivery, no revisions are offered.",
      "studio rjl designs intuitively â slight variants will often be available in your palette, so you can implement the most aligned version of the design direction.",
  ...
  },
  {
    ...
    tagline: "a complete, bespoke brandscape â crafted for brands and places with soul.",
    image: "interior-brandscape-design-warm-light.jpg",
    imageAlt: "warm interior brandscape concept by studio rjl with layered textures and soft light",
    summary: [
      "a bespoke and uniquely tailored brandscape that truly elevates you â shaping the tone, texture and gesture of your brand across identity, print, packaging, digital and place. every element designed and curated for you, from strategy through to launch."
    ],
    steps: [],
    includes: [],
    notes: [
      "each bespoke brandscape is scoped individually â timeline, deliverables and investment are confirmed in your proposal after a discovery call."
    ],
...
// trimmed set for the enquiry form only â keeps the form frictionless;
...
// private property portfolio â served at /portfolio/property/ for pitch clients.
...
// arrives â swap the entries below when it does. one note sits under every three
...
// placeholder notes in the studio voice â replace with your own words when ready.
export const propertyPortfolioNotes = [
  {
    paragraphs: [
      "every place begins with a feeling. studio rjl shapes spatial identities for developments, venues and places that want soul â atmosphere before ornament, story before styling.",
      "this is a placeholder note. replace it with your words, and the page will carry them exactly as they are."
    ]
  },
  {
    paragraphs: [
      "from material and palette to light, texture and gesture â a brandscape gives a place a name for its own feeling, before a single wall is styled.",
      "this is a placeholder note. replace it with your words, and the page will carry them exactly as they are."
    ]
  },
  {
    paragraphs: [
      "if you are building something with atmosphere, I would love to hear about it â enquire via the form below, or write to hello@studiorjl.com.",
      "this is a placeholder note. replace it with your words, and the page will carry them exactly as they are."
    ]
  }
];
